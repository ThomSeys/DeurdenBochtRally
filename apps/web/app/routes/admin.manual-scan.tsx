...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  await requestLogger.info('page-view', 'Admin manual scan loaded');
...
export default function AdminManualScan() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-br from-pink-900 via-pink-600 to-pink-400 text-white py-16 overflow-hidden">
